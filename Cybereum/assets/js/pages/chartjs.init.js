!(function (n) {
  ...
  n(function () {
    ...
    if (n("#barChart").length) {
      var a = n("#barChart").get(0).getContext("2d");
      new Chart(a, {
        type: "bar",
        data: {
          labels: [
    ...
    if (n("#areaChart").length) {
      var r = n("#areaChart").get(0).getContext("2d");
      new Chart(r, {
        type: "line",
        data: {
          labels: [
    ...
    if ((areaChart, n("#pieChart").length)) {
      var o = n("#pieChart").get(0).getContext("2d");
      new Chart(o, {
        type: "pie",
        data: {
          datasets: [
    ...
    if (n("#donut-chart1").length)
      (o = n("#donut-chart1").get(0).getContext("2d")),
        new Chart(o, {
          type: "pie",
          data: {
            datasets: [
    ...
    if (n("#radar-chart").length) {
      var t = n("#radar-chart").get(0).getContext("2d");
      new Chart(t, {
        type: "radar",
        data: {
          datasets: [
