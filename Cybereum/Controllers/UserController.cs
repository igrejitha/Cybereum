...
namespace Cybereum.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public string AcceptUser(int datuserid)
        {
            ...
            var UserLink = "/Account/AdminLogin";
        ...
        [Authorize]
        [SessionTimeout]
        public ViewResult AddUsers(int? id, tblloginMetadata Users)
        {
            //ViewBag.roleid = new SelectList(db.tbl_userrole, "roleid", "rolename");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddUsers([Bind(Include = "userid,username,password,roleid,firstname,lastname,isactive,emailid,organization,createddate,emailverification,otp,activationcode,pmuserid")] tblloginMetadata logindetails)
                ...
                switch (objList)
                {
                    ...
                    default:
                        ...
                        if (logindetails.userid == 0)
                        {
                            ...
                            IGUtilities.SendRegisterEmailToUser(link, user.emailid, user.activationcode, user.firstname + " " + user.lastname);
                            message = "Verification mail sent to your mail id";
                            TempData["SuccessMessage"] = "Verification mail sent to your mail id";
                        }
                        else
                        {
