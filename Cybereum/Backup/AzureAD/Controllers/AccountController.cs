...
namespace Cybereum.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            string myclientId = ConfigurationManager.AppSettings["ClientId"];
            string mytenant = ConfigurationManager.AppSettings["Tenant"];
            string myaadInstance = ConfigurationManager.AppSettings["AADInstance"];
            string mypostLogoutRedirectUri = ConfigurationManager.AppSettings["PostLogoutRedirectUri"];
            string authority = string.Format(CultureInfo.InvariantCulture, myaadInstance, mytenant);
            try
            {
                ...
                try
                {
                    //var result = Task.Run(async () => await authContext.AcquireTokenAsync(myaadInstance, myclientId, mypostLogoutRedirectUri, new PlatformParameters(PromptBehavior.Always))).Result;
                ...
                //string tenantId = "6b8edcc8-cbde-4cf1-b1cd-49c91f45ab77";
                //string clientId = "4f18c970-d851-49ef-93a4-92d102163867";
                //string secret = "58618637-23d7-46c1-bd2d-18656ec5d4b2";
